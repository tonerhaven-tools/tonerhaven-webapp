        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <p style={{ marginTop: "20px", fontStyle: "italic" }}>
              Your trusted source for premium toners, printer parts, and
              top-notch service. <br />
              <br />
              We specialize in delivering high-quality products and exceptional
              customer support, ensuring your printing needs are met with utmost
              satisfaction. Experience excellence in every print.
            </p>
          </div>
          <div className="col-md-4">
            ...
            <ul>
              {footerMenuItems.map((menuItem) => (
                <li className="nav-item" key={menuItem.name}>
                  <a className="nav-link" href={menuItem.path} tabIndex="-1">
                    <b>{menuItem.name}</b>
                  </a>
                </li>
              ))}
          ...
          <div className="col-md-4">
            ...
            <p>
              Warehouse: 10655 NW 122nd Street Miami, FL 33178 Phone:
              877-781-5112
            </p>
          </div>
        </div>
