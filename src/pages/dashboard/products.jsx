...
import { Page, DashboardLayout } from "@/shared/components";
    ...
    <DashboardLayout>
      <div>
        ...
        <table
          ...
          style={{ border: "1px solid #d1d1d1", marginTop: "30px" }}
        >
          <thead>
            <tr>
              <th>ID</th>
                  ...
                  <div className={"form-group"}>
                    ...
                    <select ref={ref_brand_id} className="form-control">
                      ...
                      {brands.map((brands, key) => (
                        <option value={brands.id} key={key}>
                          {brands.brand_name}
                        </option>
                      ))}
                    </select>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className={"form-group"}>
                    <label>
                      Thumbnail{" "}
                      <a href={GetCurrentImage()} target={"__blank"}>
                        See Current Image
                      </a>
                    </label>
                    <input
